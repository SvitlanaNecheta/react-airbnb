...
function App() {
  ...
  return <Page>
   ...
   <Price
    ...
    cleaning_fee={data.price.cleaning_fee}
    service_fee={data.price.service_fee}
    checkin_date={data.availability.checkin_date}
    checkout_date={data.availability.checkout_date}
   />
   <RoomList list={data.roomTypes} />
  
   <Description title="Опис"
  children={data.description} />
  <Propertyes guests={data.property_details.guests} 
 ...
 <AddProperties 
  ...
  checkin-instr={data.additional_properties["check-in_instructions"]}
 />
<ReveiwList 
